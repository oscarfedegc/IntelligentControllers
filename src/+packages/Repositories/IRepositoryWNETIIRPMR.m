classdef IRepositoryWNETIIRPMR < Repository
    ...
    methods (Access = protected)        
        function writeHiddenNeuronLayer(self, instants)
            [scales, shifts, tau, funcOutput, dfuncOutput] = ...
                self.neuralNetwork.hiddenNeuronLayer.getPerformance();
        ...
        function writeSynapticWeights(self, instants, labels)
            ...
            synaptics = network.perfSynapticWeights;
            
            outputs_ = network.outputs;
            neurons = network.hiddenNeuronLayer.getNeurons();
