...
classdef IWNETIIRPID < Strategy
    ...
    methods (Access = public)
        ...
        function setup(self)
            ...
            switch test
                case 1
                    self.references = struct('pitch', [-40 20 20 20 20 20], ...
                                             'yaw', [0 30 30 30 30]);
                case 2
