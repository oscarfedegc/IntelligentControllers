...
classdef IClassicalPIDPert < Strategy
    properties (Access = public)
        PREFIX = 'Classical PID'; % It is use to create the folder and output files
    ...
    methods (Access = public)
        % Class constructor
        function self = IClassicalPIDPert()
            return
        end
        ...
        function builder(self)
            ...
            if strcmp(self.typeReference,'T01') || strcmp(self.typeReference,'T03')
            ...
            self.repository = IRepositoryClassicalPID(self.PREFIX);
...
%                 self.model.addPerturbation(perturbation, iter);
    ...
    methods (Access = protected)
        ...
        %
        function log(self, kT, reference, measured, tracking, control)
            clc
