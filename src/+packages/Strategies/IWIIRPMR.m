...
classdef IWIIRPMR < Strategy
    ...
    methods (Access = public)
        ...
        function setup(self)
            ...
            self.controllerGains = struct('pitch', [900 0 50 50 0 200], ...
                                            'yaw', [750 0 50 50 0 100]);
            self.controllerRates = struct('pitch', [10 10 10 10 10 10],...
                                            'yaw', [10 10 10 10 10 10]);
            ...
            self.feedbacks = 4;
            self.feedforwards = 2;
            self.persistentSignal = 5e-1;
            
            self.nnaType = NetworkList.Wavenet;
            self.inputs = 2;
            self.outputs = 2;
            
            self.learningRates = [7e-5 7e-5 7e-5 1e-10 3e-6];
        end
    ...
    methods (Access = protected)
        ...
        function log(self, kT, reference, measured, estimated, tracking, identification, control, gamma)
            ...
            fprintf('PITCH >> yRef = %+06.3f   yMes = %+06.3f   yEst = %+06.3f   eTck = %+06.3f   eIdf = %+06.3f   signal = %+06.3f   gamma = %+06.3f\n', ...
                reference(1), measured(1), estimated(1), tracking(1), identification(1), control(1), gamma(1))
            fprintf('  YAW >> yRef = %+06.3f   yMes = %+06.3f   yEst = %+06.3f   eTck = %+06.3f   eIdf = %+06.3f   signal = %+06.3f   gamma = %+06.3f\n', ...
