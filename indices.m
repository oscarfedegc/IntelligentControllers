...
%     pidWnetStep = 'src\+repositories\results\WAVENET-IIR PID\FLATTOP2-J03-M04-N02-G03-T060-T02-Y\FLATTOP2-J03-M04-N02-G03-T060-T02-Y PERFMODEL.csv';
    pmrWnetPoly = 'src\+repositories\results\WAVENET-IIR PMR\POLYWOG3-J03-M04-N02-G06-T060-T03-Y\POLYWOG3-J03-M04-N02-G06-T060-T03-Y PERFMODEL.csv';
...
%     labviewTune = 'src\+repositories\values\Selftune PID EFT2 processing.csv';
%     
...
%     [labviewTunePitch, labviewTunelYaw] = calculateLabiew(labviewTune, PERIOD);
...
%     reduce('ITAE', pmrWnetPitchStep(4), pmrWnetYawStep(4), pidWnetPitchStep(4), pidWnetYawStep(4), classPitchStep(4), classYawStep(4))
    ...
    function print(idx, a, b, c, d)
        fprintf('%4s & \\num{%.2f} & \\num{%.2f} & \\num{%.2f} & \\num{%.2f} & \\qty{%.2f}{\\percent} & \\qty{%.2f}{\\percent} \\\\\n', idx, a, b, d, c, percentage(a,c), percentage(b,d))
    end
